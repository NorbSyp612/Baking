...
public class PhoneTests {
    ...
    public void checkFirst() {
        ...
        onView(withId(R.id.recipe_RecyclerView2)).perform(RecyclerViewActions.actionOnItemAtPosition(4, click()));
        onView(withId(R.id.step_description)).check(matches(withText(First_Recipe_Step)));
    ...
    public void checkSecond() {
        ...
        onView(withId(R.id.recipe_RecyclerView2)).perform(RecyclerViewActions.actionOnItemAtPosition(3, click()));
        onView(withId(R.id.step_description)).check(matches(withText(Second_Recipe_Step)));
    }
    ...
    public void checkThird() {
        ...
        onView(withId(R.id.recipe_RecyclerView2)).perform(RecyclerViewActions.actionOnItemAtPosition(3, click()));
        onView(withId(R.id.step_description)).check(matches(withText(Third_Recipe_Step)));
    }
    ...
    public void checkFourth() {
        ...
        onView(withId(R.id.recipe_RecyclerView2)).perform(RecyclerViewActions.actionOnItemAtPosition(3, click()));
        onView(withId(R.id.step_description)).check(matches(withText(Fourth_Recipe_Step)));
    }
}
